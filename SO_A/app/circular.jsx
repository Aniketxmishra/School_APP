...
const SyllabusZone = () => {
    ...
    const handleSubmit = () => {
        ...
        if (teacherName && selectedClass && yearStart && yearEnd && pdfUri) {
            // Add a new notification to the syllabus list with relevant data
            const newSyllabus = { teacherName, selectedClass, yearStart, yearEnd, pdfUri };
            setSyllabusList([
                ...syllabusList,
                newSyllabus,
            ]);
    ...
    return (
        <View style={{ padding: 20, backgroundColor: '#FEFAE0', paddingBottom: 500 }}>
            <Text style={{ fontSize: 24, fontWeight: "bold", textAlign: "center" }}>Syllabus Zone</Text>
            ...
            <View style={{ marginTop: 10 }}>
                ...
                >
                    <Text style={{ color: 'black', fontSize: 16, fontWeight: '600', }}>ADD Syllabus of the class</Text>
                </TouchableOpacity>
            </View>

            <View style={{ alignItems: 'center', borderBottomWidth: 1, backgroundColor: '#EFEFEF', borderRadius: 20, }}>
                <Text style={{ fontSize: 18, marginTop: 5, fontWeight: "bold", paddingHorizontal: 10 }}>Syllabus AVAILABLE</Text>
            </View>
            ...
            <FlatList
                ...
                renderItem={({ item }) => (
                    <TouchableOpacity
                        ...
                        style={{ padding: 10, borderWidth: 1, marginTop: 10, borderRadius: 5 }}
                    >
                        ...
                        <Text style={{ fontWeight: 'bold', fontSize: 12 }}>Session: <Text style={{ fontWeight: '300' }}>{item.yearStart}-{item.yearEnd}</Text></Text>
                        <Text style={{ fontWeight: 'bold', fontSize: 12 }}>Uploaded By: <Text style={{ fontWeight: '300' }}> {item.teacherName}</Text></Text>
                        <View style={{alignItems: 'center', marginTop:5,}}>
                            <Text style={[styles.listItemText, { color: 'blue' }]}>Tap to view the Syllabus PDF</Text>
                        </View>
                    </TouchableOpacity>
                )}
            />
            ...
            <Modal visible={modalVisible} animationType="slide">
                <KeyboardAvoidingView>
                    <ScrollView>
                        <View style={{ padding: 20, backgroundColor: "#FFFECE", paddingBottom: 150, }}>
                            ...
                            <View style={{ paddingTop: 10 }}>
                                <View style={{ flexDirection: "row" }}>
                                    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                        ...
                                        <Text style={{ fontSize: 16 }}>Select Start Year : </Text>
                                    </View>
                                </View>
                            ...
                            <View>
                                {/* Label for Year End */}
                                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                    <Icon name="date-range" size={20} color="black" style={{ marginRight: 10 }} />
                                    <Text style={{ fontSize: 16 }}>Select End Year : </Text>
                                </View>
                                ...
                                <View style={{ marginLeft: 20, marginTop: 5 }}>
                                    <TouchableOpacity onPress={() => setShowEndDatePicker(true)}>
                                        <TextInput
                                            placeholder="Press to set the END Year"
                                            value={yearEnd}
                                            style={styles.input}
                                            editable={false} // Make input non-editable
                                        />
                                ...
                                {showEndDatePicker && (
                                    <DateTimePicker
                                        ...
                                        maximumDate={new Date(new Date().setFullYear(new Date().getFullYear() + 30))}// Prevent future date selection
                                    />
                                )}
                            </View>
